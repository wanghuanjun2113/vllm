    ...
    def build(  # type: ignore[override]
        ...
        if (
            ...
            if num_spec_decodes == 0:
                ...
                # aclnnNonzeroV2 synchronization on NPU during indexing
                spec_indices_cpu = torch.nonzero(
                    spec_sequence_masks_cpu, as_tuple=True
                )[0].to(torch.int32).pin_memory()
                non_spec_indices_cpu = torch.nonzero(
                    ~spec_sequence_masks_cpu, as_tuple=True
                )[0].to(torch.int32).pin_memory()
        ...
        if spec_sequence_masks is None:
            ...
            if num_prefills == 0 and num_decodes == 0:
                ...
                # to eliminate aclnnNonzeroV2 synchronization on NPU
